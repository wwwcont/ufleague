...
export interface MatchesRepository {
  ...
  updateMatch?(matchId: string, patch: Partial<{ status: Match['status']; homeScore: number; awayScore: number; venue: string; broadcastUrl: string; diskUrl: string; stage: string; tour: string; referee: string }>): Promise<void>
}
